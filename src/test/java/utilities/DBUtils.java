...
//----------------------------------------------------------------------------------------------------------------------
     ...
     */
    public static Object getCellValue(String query) {    // ==> parametre olarak query giriliyor
        return getQueryResultList(query).get(0).get(0);  // ==> ilk hücrenin değerini bize döndürüyor.
    }

    public static Object getSecondCellValue(String query) {
        return getQueryResultList(query).get(0).get(1);  // ==> ikinci hücrenin değerini bize döndürüyor.
    }
    /**
     *
     * @param query //
     ...
     *
     */
    public static List<Object> getRowList(String query) { // ==> dataları list olarak döndürüyor
     ...
     */
    public static Map<String, Object> getRowMap(String query) { // ==> dataları map olarak döndürüyor
